    ...
    <footer className="bg-gray-900 text-gray-400 py-12 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-white text-lg font-bold mb-4">GENOVA</h3>
            <p className="mb-4">
              Soluciones tecnológicas innovadoras para empresas que buscan destacar en el mercado digital.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Branding Corporativo</a></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center">
          <p>&copy; {new Date().getFullYear()} Genova. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
